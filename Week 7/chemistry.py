...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    for element in symbol_quantity_list:
        ...
        p_molar_mass = atomic_mass * quantity
    ...
    for symbol, quantity in symbol_quantity_list:
        #use periodic table in this for loop
        if symbol in periodic_table == NAME_INDEX:
            ATOMIC_MASS_INDEX * quantity
    """

def main():
    # Get a chemical formula for a molecule from the user.
    mole_formula = input("Enter the molecular formula of the sample: ")
    ...
    formula = parse_formula(mole_formula, periodic_table)
    ...
    #grams/mole
    total = mass_grams / molar_mass
    # Print the molar mass.
    print(f"{round(molar_mass, 5)} grams/mole")
    # Print the number of moles.
    print(f"{round(total, 5)} moles")
